...
const { getTransactions, getLastFiveTransactions, addTransaction, deleteTransaction, updateTransaction, getSummary, getDataByType } = require('../controllers/transaction-controller');
...
router.post('/transactions/type', getDataByType)
